...
const Details = () =>
    import ('@/components/TokenViewItemDetails');
const SignInDesk = () =>
    import ('@/components/SignInDesk');
const RegAccout = () =>
    import ('@/components/RegAccout');
const MyTeam = () =>
    import ('@/components/MyTeam');
const PromotionActivity = () =>
    import ('@/components/PromotionActivity');
const SystemSetting = () =>
    import ('@/components/page4Setting');
const Certification = () =>
    import ('@/components/Certification');
const WordBook = () =>
    import ('@/components/WordBook');
const EditLoginPwd = () =>
    import ('@/components/EditLoginPwd');
const EditPayPwd = () =>
    import ('@/components/EditPayPwd');
const NewsDetails = () =>
    import ('@/components/NewsDetails');
const TransferPage = () =>
    import ('@/components/TransferPage');
const TransferList = () =>
    import ('@/components/TransferList');

const SystemNewsList = () =>
    import ('@/components/SystemNewsList');
const SystemNewsInfo = () =>
    import ('@/components/SystemNewsInfo');
const TokenTransForm = () =>
    import ('@/components/TokenTansform')
